...
const rootFiles=['.npmrc','components.json','package.json','package-lock.json','vite.config.ts','tsconfig.json','drizzle.config.ts','cloudflare-env.d.ts','next.config.ts','postcss.config.mjs','eslint.config.mjs','.gitignore','.openai/hosting.json','README.md','SUBMISSION.md'];
const files={};
